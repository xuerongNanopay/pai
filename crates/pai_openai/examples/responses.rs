...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let request = pai_openai::ResponseCreateRequest::with_items(
        ...
        [
            pai_openai::InputItem::Message(pai_openai::InputMessage::developer(
                "Write in a warm, gentle bedtime-story style.",
            )),
            pai_openai::InputItem::Message(pai_openai::InputMessage::user(
